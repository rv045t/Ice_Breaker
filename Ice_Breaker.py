...
def ice_break(name: str) -> Tuple[PersonIntel, str]:
    ...
    tweets = scrape_user_tweets(username=name, num_tweets=5)

    summary_template = """
         given the Linkedin information {linkedin_information} and twitter information {twitter_information} about a 
         person from I want you to create:
         1. a short summary
    ...
    res = chain.run(linkedin_information=linkedin_data, twitter_information=tweets)
